...
export const API = {
    ...
    getUserInfo(token: string) {
        return instance.get<any, AxiosResponse<UserInfoResponceType>, any>('/user/info', { headers: { Authorization: `Bearer ${token}` }})
    },
    getUserStat(token: string) {
        return instance.get<any, AxiosResponse<UserStatResponceType>, any>('/user/stat',  { headers: { Authorization: `Bearer ${token}`}})
    }
}
